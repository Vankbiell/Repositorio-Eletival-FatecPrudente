...
<li class="nav-item dropdown">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdown1">
    ...
    <li><a class="dropdown-item" href="ex_6.php">Exercício 6</a></li>
    <li><a class="dropdown-item" href="ex_7.php">Exercício 7</a></li>
    <li><a class="dropdown-item" href="ex_8.php">Exercício 8</a></li>
    <li><a class="dropdown-item" href="ex_9.php">Exercício 9</a></li>
    <li><a class="dropdown-item" href="ex_10.php">Exercício 10</a></li>
  </ul>
</li>
      </ul>
    </div>
