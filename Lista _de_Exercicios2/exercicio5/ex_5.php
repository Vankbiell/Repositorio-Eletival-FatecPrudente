...
<title>Exercício 5 - Soma de três notas e apresentação da media de das três</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" >
</head>
<body> 
<div class="container">
<h1>Exercício 5 - Soma de três notas e apresentação da media de das três</h1>
<form method="post" action ="resex_5.php">
<div class="mb-3">
